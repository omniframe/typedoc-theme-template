...
export function navigation( context: __THEME_NAME__ThemeRenderContext, props: PageEvent<Reflection> ) {
	return (
		<>
...
function primaryNavigation( context: __THEME_NAME__ThemeRenderContext, props: PageEvent<Reflection> ) {
...
function secondaryNavigation( context: __THEME_NAME__ThemeRenderContext, props: PageEvent<Reflection> ) {
