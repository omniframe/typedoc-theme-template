...
function renderUniquePath( context: __THEME_NAME__ThemeRenderContext, reflection: Reflection ): JSX.Element {
...
function renderType( context: __THEME_NAME__ThemeRenderContext, type: Type | undefined, options?: TypeInlinePartialsOptions ) {
	if ( !type ) {
...
export function type( context: __THEME_NAME__ThemeRenderContext, type: Type | undefined ) {
